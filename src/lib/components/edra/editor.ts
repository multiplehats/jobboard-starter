...
import { ColorHighlighter } from './extensions/color-highlighter.js';
import { FontSize, TextStyle, Color } from '@tiptap/extension-text-style';
import TextAlign from '@tiptap/extension-text-align';
import Highlight from '@tiptap/extension-highlight';
import SearchAndReplace from './extensions/find-and-replace.js';
...
import { InlineMathReplacer } from './extensions/inline-math-replacer.js';
