<script lang="ts">
	...
	import FontSize from './components/toolbar/font-size.svelte';
	import Headings from './components/toolbar/headings.svelte';
	import QuickColors from './components/toolbar/quick-colors.svelte';
	import SearchAndReplace from './components/toolbar/search-and-replace.svelte';
